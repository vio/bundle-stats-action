...
const extractAssets = (webpackStats) => {
    const webpackAssets = (0, get_1.default)(webpackStats, 'assets', []);
    const webpackChunks = (0, get_1.default)(webpackStats, 'chunks', []);
    const webpackEntrypoints = (0, get_1.default)(webpackStats, 'entrypoints', {});
